...
#define FMOD_VERSION    0x00010501
...
struct FMOD_ASYNCREADINFO
{
    ...
    void    (*done)(FMOD_ASYNCREADINFO *info, FMOD_RESULT result);    /* FMOD file system wake up function.  Call this when user file read is finished.  Pass result of file read as a parameter. */
};
